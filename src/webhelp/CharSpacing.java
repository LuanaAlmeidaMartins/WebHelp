    ...
    webEngine.getLoadWorker().stateProperty().addListener((obs, oldValue, newValue) -> {
      if (newValue == State.SUCCEEDED) {
        ...
        charSpacing.setOnMouseClicked(new EventHandler<MouseEvent>() {
          ...
          public void handle(MouseEvent event) {
            ...
            WebHelpBar.applyButtonStatus.setFontStyle(
                charSpacingStatus.getCharSpacing(CharSpacingEnum.none.getCharSpacing()),
        ...
        small.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.setFontStyle(
              charSpacingStatus.getCharSpacing(CharSpacingEnum.small.getCharSpacing()),
              charSpacingStatus.isCharSpacing());
        });
        ...
        medium.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(charSpacingStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              charSpacingStatus.getCharSpacing(CharSpacingEnum.medium.getCharSpacing()),
              charSpacingStatus.isCharSpacing());
        });
        ...
        big.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(charSpacingStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              charSpacingStatus.getCharSpacing(CharSpacingEnum.big.getCharSpacing()),
              charSpacingStatus.isCharSpacing());
        });
      }
    });
