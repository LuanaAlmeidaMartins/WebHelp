    ...
    webEngine.getLoadWorker().stateProperty().addListener((obs, oldValue, newValue) -> {
      if (newValue == State.SUCCEEDED) {
        ...
        fontFamilyMenu.setOnMouseClicked(new EventHandler<MouseEvent>() {
          ...
          public void handle(MouseEvent event) {
            ...
            WebHelpBar.applyButtonStatus.setFontStyle(
                fontFamilyStatus.getFamilyFont(FontFamilyEnum.none.getFont()),
        ...
        openDyslexic.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontFamilyStatus.getFamilyFont(FontFamilyEnum.openDyslexic.getFont()),
              fontFamilyStatus.isFontFamily());
        });
        ...
        openSans.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(fontFamilyStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontFamilyStatus.getFamilyFont(FontFamilyEnum.openSans.getFont()),
              fontFamilyStatus.isFontFamily());
        });
        ...
        comicSans.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(fontFamilyStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontFamilyStatus.getFamilyFont(FontFamilyEnum.comicSans.getFont()),
              fontFamilyStatus.isFontFamily());
        });
        ...
        georgia.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(fontFamilyStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontFamilyStatus.getFamilyFont(FontFamilyEnum.georgia.getFont()),
              fontFamilyStatus.isFontFamily());
        });
      }
    });
