    ...
    webEngine.getLoadWorker().stateProperty().addListener((obs, oldValue, newValue) -> {
      if (newValue == State.SUCCEEDED) {
        ...
        fontSize.setOnMouseClicked(new EventHandler<MouseEvent>() {
          ...
          public void handle(MouseEvent event) {
            ...
            WebHelpBar.applyButtonStatus.setFontStyle(
                fontSizeStatus.getSizeFont(FontSizeEnum.none.getFont()),
        ...
        enorme.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontSizeStatus.getSizeFont(FontSizeEnum.enorme.getFont()),
              fontSizeStatus.isFontSize());
        });
        ...
        grande.setOnAction(actionEvent -> {
          fontSizeStatus.setOptionSize();
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontSizeStatus.getSizeFont(FontSizeEnum.grande.getFont()),
              fontSizeStatus.isFontSize());
        });
        ...
        medio.setOnAction(actionEvent -> {
          fontSizeStatus.setOptionSize();
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontSizeStatus.getSizeFont(FontSizeEnum.medio.getFont()),
              fontSizeStatus.isFontSize());
        });
        ...
        pequeno.setOnAction(actionEvent -> {
          fontSizeStatus.setOptionSize();
          WebHelpBar.applyButtonStatus.setFontStyle(
              fontSizeStatus.getSizeFont(FontSizeEnum.pequeno.getFont()),
              fontSizeStatus.isFontSize());
        });
      }
    });
