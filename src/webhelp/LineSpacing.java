    ...
    webEngine.getLoadWorker().stateProperty().addListener((obs, oldValue, newValue) -> {
      if (newValue == State.SUCCEEDED) {
        ...
        lineSpacingMenu.setOnMouseClicked(new EventHandler<MouseEvent>() {
          ...
          public void handle(MouseEvent event) {
            ...
            WebHelpBar.applyButtonStatus.setFontStyle(
                lineSpacingStatus.getLineSpacing(LineSpacingEnum.none.getLineSpacing()),
        ...
        lineSimples.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.setFontStyle(
              lineSpacingStatus.getLineSpacing(LineSpacingEnum.lineSimples.getLineSpacing()),
              lineSpacingStatus.isLineSpacing());
        });
        ...
        line15.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(lineSpacingStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              lineSpacingStatus.getLineSpacing(LineSpacingEnum.line15.getLineSpacing()),
              lineSpacingStatus.isLineSpacing());
        });
        ...
        line5.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(lineSpacingStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              lineSpacingStatus.getLineSpacing(LineSpacingEnum.line5.getLineSpacing()),
              lineSpacingStatus.isLineSpacing());
        });
        ...
        linhaDupla.setOnAction(actionEvent -> {
          ...
          WebHelpBar.applyButtonStatus.removeFontStyle(lineSpacingStatus.getRemoveOption());
          WebHelpBar.applyButtonStatus.setFontStyle(
              lineSpacingStatus.getLineSpacing(LineSpacingEnum.linhaDupla.getLineSpacing()),
              lineSpacingStatus.isLineSpacing());
        });
      }
    });
